...
public static class DbSeeder
{
    public static async Task SeederAsync(AppDbContext  dbContext)
    {
        ...
        var activaEstandar = new Subasta()
        {
            ...
            UrlImagen = "https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=600&auto=format&fit=crop&q=80",
            PrecioBase = 30000,
        ...
        var activaCritica = new Subasta()
        {
            ...
            UrlImagen = "https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=600&auto=format&fit=crop&q=80",
            PrecioBase = 10000,
        ...
        var vencidaConGanador = new Subasta()
        {
            ...
            UrlImagen = "https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=600&auto=format&fit=crop&q=80",
            PrecioBase = 50000,
            IncrementoMinimo = 5000,
        ...
        var vencidaDesierta = new Subasta()
        {
            ...
            UrlImagen = "https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=600&auto=format&fit=crop&q=80",
            PrecioBase = 20000,
            IncrementoMinimo = 1000,
            FechaInicio = ahora.AddHours(-3),
